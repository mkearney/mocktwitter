...
Use `mocktwitter_status()` with a status URL, status ID, or [rtweet](http://rtweet.info) status data to create a [mock-up of a Twitter status HTML page](https://htmlpreview.github.io/?https://github.com/mkearney/mocktwitter/blob/master/tools/readme/ex.html):
...
Use `mocktwitter_timeline()` with a user URL, screen name, user ID, or [rtweet](http://rtweet.info) timeline data to create a [mock-up of a Twitter status HTML page](https://htmlpreview.github.io/?https://github.com/mkearney/mocktwitter/blob/master/tools/readme/ex.html):
