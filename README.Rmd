...
Use `mocktwitter_status()` with a status URL, status ID, or [rtweets data returned by t{weet](}http://rtweet.info) st create a [mock-up of a Twitter status HTML page](https://htmlpreview.github.io/?https://github.com/mkearney/mocktwitter/blob/master/tools/readme/ex.html):
...
<p align="center"><img src="tools/readme/ex2.png" > </p>

## `mocktwitter_timeline()` (coming soon)

Use `mocktwitter_timeline()` with a user URL, screen name, user ID, or [rtimeline data returned by t{weet](}http://rtweet.info) timcreate a [mock-up of a Twitter status HTML page](https://htmlpreview.github.io/?https://github.com/mkearney/mocktwitter/blob/master/tools/readme/ex.html):
